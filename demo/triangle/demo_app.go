...
func (this *DemoApp) Init() {
	...
	var err error
	// Shader
	this.vertexShader, err = createShader(gl.VERTEX_SHADER, "data/shaders/triangle/main.vert.glsl")
	if err != nil {
		panic(err)
	}

	this.fragmentShader, err = createShader(gl.FRAGMENT_SHADER, "data/shaders/triangle/main.frag.glsl")
	if err != nil {
		panic(err)
	}
