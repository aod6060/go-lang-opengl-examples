...
func (this *DemoApp) Init() {
	...
	var err error
	// Shader
	this.vertexShader, err = createShader(gl.VERTEX_SHADER, "data/shaders/glw_test/main.vert.glsl")
	if err != nil {
		panic(err)
	}

	this.fragmentShader, err = createShader(gl.FRAGMENT_SHADER, "data/shaders/glw_test/main.frag.glsl")
	if err != nil {
		panic(err)
	}
