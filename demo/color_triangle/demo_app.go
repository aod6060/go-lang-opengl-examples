...
func (this *DemoApp) Init() {
	...
	var err error
	// Shader
	this.vertexShader, err = createShader(gl.VERTEX_SHADER, "data/shaders/color_triangle/main.vert.glsl")
	if err != nil {
		panic(err)
	}

	this.fragmentShader, err = createShader(gl.FRAGMENT_SHADER, "data/shaders/color_triangle/main.frag.glsl")
	if err != nil {
		panic(err)
	}
	...
	this.verticesList = addFloat3f(this.verticesList, 0.0, 1.0, 0.0)
