...
func (this *DemoApp) Init() {
	...
	var err error
	// Shader
	this.vertexShader, err = createShader(gl.VERTEX_SHADER, "data/shaders/textures/main.vert.glsl")
	if err != nil {
		panic(err)
	}

	this.fragmentShader, err = createShader(gl.FRAGMENT_SHADER, "data/shaders/textures/main.frag.glsl")
	if err != nil {
		panic(err)
	}
	...
	this.texCoordList = addFloat2f(this.texCoordList, 0.0, 0.0)
	this.texCoordList = addFloat2f(this.texCoordList, 1.0, 0.0)
	this.texCoordList = addFloat2f(this.texCoordList, 0.0, 1.0)
	this.texCoordList = addFloat2f(this.texCoordList, 1.0, 1.0)
